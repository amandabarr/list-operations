...
def top(input_list):
    ...
    list_without_last_item = input_list[:-1]
...
def first_three(input_list):
    ...
    list_of_first_three = input_list[0:3]

    return list_of_first_three
...
def inner_four(input_list):
    ...
    list_of_inner_four = input_list[2:6]

    return list_of_inner_four
